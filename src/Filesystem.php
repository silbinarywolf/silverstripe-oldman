...
class Filesystem
{
     ...
     * @var    array
     */
    private static $blacklist_filenames = [
        '.',
        '..',
        '.git',
        '.svn',
     ...
     * @var    array
     */
    private static $blacklist_absolute_pathnames = [];
    ...
    public function getFilesWithExtensionsRecursively($directory, array $extensionsToMatch)
    {
        ...
        $ignored_filename_list = Config::inst()->get(self::class, 'blacklist_filenames');
        $ignored_pathname_list = [];
        if (!Config::inst()->get(self::class, 'disable_default_blacklist_absolute_pathnames')) {
            $ignored_pathname_list = $this->defaultBlacklistAbsolutePathnames;
        }
        $custom_ignored_pathname_list = Config::inst()->get(self::class, 'blacklist_absolute_pathnames');
